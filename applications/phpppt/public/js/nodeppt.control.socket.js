var socketIOURL = '//' + location.host + '/socket.io-client/socket.io.js';
...
Slide.Control.add('socket', function (S, broadcast) {
    ...
    var Socket = {
        ...
        controlConnect: function () {
            console.log('controlConnect');
            webSocket.emit('control.login', 'Control');
        ...
        connect: function () {
            ...
            webSocket = io.connect('http://'+document.domain+':2020');
